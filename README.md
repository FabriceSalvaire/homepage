...
docs](https://docs.astro.build/en/guides/content-collections/) to learn more.
...
**Warning:** `npm run build` checks the sources ! Use `npm run astro build` to get ride of errors...
